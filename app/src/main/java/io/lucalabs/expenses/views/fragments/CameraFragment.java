...
public class CameraFragment extends Fragment
    ...
    /**
     * Used to detect double tap on screen.
     */
    ...
    /**
     * This is the output folder for our picture
     */
    ...
    private void createImageFolder() {
        ...
        mFolder = new File(imageFile, "receipt_queue");
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        view.findViewById(R.id.camera_capture_button).setOnClickListener(this);
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                Size largest = chooseOptimalSize(map.getOutputSizes(SurfaceTexture.class),
...
//            requestCameraPermission();
    ...
    private void captureStillPicture() {
        try {
            ...
            // TEMPLATE_PREVIEW seems to yield better results than TEMPLATE_STILL_PICTURE
